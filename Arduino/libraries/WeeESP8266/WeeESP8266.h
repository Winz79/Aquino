...
class ESP8266 {
 public:
	...
	ESP8266(HardwareSerial &uart, int resetPin, uint32_t baud = 9600);
#endif
 ...
 private:
	...
	* Recvive data from uart. Return all received data if one of target1, target2 and target3 found or timeout.
	*/
	String recvString(String target1, String target2, String target3, String target4, uint32_t timeout = 1000);
